...
## ***Audio Demo***
This section presents audio samples from the CineSpeech dataset alongside speech synthesized by our proposed baseline model, CineTTS. For comparison, we also include the corresponding outputs generated by other models (MSenC, StyleTTS2, and IndexTTS2).
...
<table style="width:100%; table-layout: fixed; border-collapse: collapse;" border="1">
  <tbody>
    ...
    <tr>
      <th style="width:25%;">Speaker Description</th>
      <td>
      ...
      <td>
        <table style="border-collapse: collapse; border: none;">
          ...
          <tr>
            ...
            <td style="border:none;">
              <audio controls src="wavs/samples/569_CineTTS.wav"></audio>
            </td>
          </tr>
      ...
      <td>
        <table style="border-collapse: collapse; border: none;">
          ...
          <tr>
            ...
            <td style="border:none;">
              <audio controls src="wavs/samples/620_CineTTS.wav"></audio>
            </td>
          </tr>
      ...
      <td>
        <table style="border-collapse: collapse; border: none;">
          ...
          <tr>
            ...
            <td style="border:none;">
              <audio controls src="wavs/samples/844_CineTTS.wav"></audio>
            </td>
          </tr>
      ...
      <td>
        <table style="border-collapse: collapse; border: none;">
          ...
          <tr>
            ...
            <td style="border:none;">
              <audio controls src="wavs/samples/918_CineTTS.wav"></audio>
            </td>
          </tr>
      ...
      <td>
        <table style="border-collapse: collapse; border: none;">
          ...
          <tr>
            ...
            <td style="border:none;">
              <audio controls src="wavs/samples/986_CineTTS.wav"></audio>
            </td>
          </tr>
