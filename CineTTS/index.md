...
---
## CineTTS Dataset
We present some examples of the dataset below.

---

## Baseline Model Outputs
We present some examples of speech synthesized by CineTTS, along with other baseline models used in the experiment.
