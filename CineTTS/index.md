...
## ***Audio Demo***
This section presents audio samples from the CineSpeech dataset alongside speech synthesized by our proposed baseline model, CineTTS. For comparison, we also include the corresponding outputs generated by the other models evaluated in our experiments, namely MSenC, StyleTTS2, and IndexTTS2.
