...
## ***Audio Demo***
We prode exviamples from our proposed dataset alongside speech generated by our proposed baseline model (CineTTS), as well as corresponding audio outputs from the other models used in our experiments (MSenC, StyleTTS2, IndexTTS2).
...
---
## ***Varying Persona***
In this section, we demonstrate our model's outputs in scenarios where the reference speech, dialog history and target utterance are the same, but **<u>speaker characteristics are different</u>**. 
