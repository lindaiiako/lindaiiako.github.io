...
## ***Audio Demo***
We provide examples from our proposed dataset alongside speech generated by our proposed baseline model (CineTTS), as well as corresponding audio outputs from the other models used in our experiments (MSenC, StyleTTS2, IndexTTS2).
